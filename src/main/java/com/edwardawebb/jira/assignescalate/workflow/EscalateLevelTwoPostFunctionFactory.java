...
public class EscalateLevelTwoPostFunctionFactory extends AbstractWorkflowPluginFactory implements WorkflowPluginFunctionFactory{

    public static final String FIELD_MESSAGE="messageField";
    private WorkflowManager workflowManager;


    public EscalateLevelTwoPostFunctionFactory(WorkflowManager workflowManager){
